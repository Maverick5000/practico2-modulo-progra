...
class WaitlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waitlist" do
    assert_difference('Waitlist.count') do
      post waitlists_url, params: { waitlist: { client_id: @waitlist.client_id, tape_id: @waitlist.tape_id } }
    end
  ...
  test "should update waitlist" do
    patch waitlist_url(@waitlist), params: { waitlist: { client_id: @waitlist.client_id, tape_id: @waitlist.tape_id } }
